*------------------------------------------------------------*;
* Ensmbl: Combine model for premium;
*------------------------------------------------------------*;
* Ensmbl: Scoring Code of model 1 of 3;
*------------------------------------------------------------*;
*------------------------------------------------------------*;
...
Reg4_WARN_ = _WARN_;
*------------------------------------------------------------*;
* Ensmbl: Scoring Code of model 2 of 3;
*------------------------------------------------------------*;
*------------------------------------------------------------*;
* TOOL: Neural;
* TYPE: MODEL;
...
*** ******************************;
IF MISSING( premium ) THEN R_premium  = . ;
ELSE R_premium  = premium  - P_premium ;
********************************;
...
*------------------------------------------------------------*;
* Ensmbl: Scoring Code of model 3 of 3;
*------------------------------------------------------------*;
*------------------------------------------------------------*;
* TOOL: Neural;
* TYPE: MODEL;
...
*------------------------------------------------------------*;
* Ensmbl: Computing Residual Var;
*------------------------------------------------------------*;
label R_premium = "Residual: premium";
R_premium = premium - P_premium;
